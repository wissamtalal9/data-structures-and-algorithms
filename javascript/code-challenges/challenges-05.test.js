...
const addValues = (arr) => {
  // Solution code here...
  let Sum= arr.reduce((array_num,value)=>{
    return array_num + value;
  },0);return Sum;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let total = arr.reduce( (array_num, value) => {
    return array_num + value.purchasePrice;
  }, 0); return total;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let NewArray = arr.reduce((Number) => {
    Number = Number + 1;
    return Number;
...
const returnNames = (arr) => {
  // Solution code here...
  let NewArray = arr.reduce((account,value,index)=>{
    account[index] = value.name;
    return account;
  },[]);
  return NewArray;
};
...
const reversedString = (str) => {
  // Solution code here...
  let NewArray = str.split('').reduce((account, item)=>{
