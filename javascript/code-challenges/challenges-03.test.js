...
const typeNum = (arr) => {
  // Solution code here...
  const filterValue = arr.filter((arr) => typeof arr === "number");
  return filterValue;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let filterValue = arr.filter((arr) => arr.includes("and"));
  return filterValue;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let filterValue = arr.filter((arr) => arr % 2 == 1);
  return filterValue;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let filterValue = arr.filter((arr) => !forbiddenValues.includes(arr));
  return filterValue;
};
